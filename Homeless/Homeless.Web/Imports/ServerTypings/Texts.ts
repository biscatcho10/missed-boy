    ...
    declare namespace Db {
        ...
        namespace HomeLess {
            ...
            namespace AbotutUs {
                ...
                export const Fb: string;
                export const Id: string;
                export const Instgram: string;
            ...
            namespace Topics {
                export const AbsenceDate: string;
                ...
                export const HouseAddress: string;
                export const Id: string;
                export const IsClosed: string;
                export const LostName: string;
                export const Mail: string;
                export const MainPhoto: string;
                export const Mobile: string;
                export const MobileUserName: string;
                export const Notes: string;
                export const Photos: string;
                export const ResonOfAbsense: string;
                export const TopicAddress: string;
                export const TopicContent: string;
            }
        }
