...
namespace MVC
{
    public static class Views
    {
        ...
        public static class HomeLess
        {
            ...
            {
                public const string CityIndex = "~/Modules/HomeLess/City/CityIndex.cshtml";
            }

            public static class Contactus
            {
                public const string ContactusIndex = "~/Modules/HomeLess/Contactus/ContactusIndex.cshtml";
            }

            public static class Country
            {
                public const string CountryIndex = "~/Modules/HomeLess/Country/CountryIndex.cshtml";
            }

            public static class Topics
            {
                public const string TopicsIndex = "~/Modules/HomeLess/Topics/TopicsIndex.cshtml";
            }
