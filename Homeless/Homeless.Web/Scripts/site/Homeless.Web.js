...
(function (Homeless) {
    ...
    })(Administration = Homeless.Administration || (Homeless.Administration = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var Administration;
...
(function (Homeless) {
    ...
    })(BasicSamples = Homeless.BasicSamples || (Homeless.BasicSamples = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Homeless.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Homeless.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Homeless.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Homeless) {
    ...
    })(Common = Homeless.Common || (Homeless.Common = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var Common;
...
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var AbotutUsForm = /** @class */ (function (_super) {
            __extends(AbotutUsForm, _super);
            function AbotutUsForm(prefix) {
                var _this = _super.call(this, prefix) || this;
                if (!AbotutUsForm.init) {
                    ...
                    var w3 = Homeless.Northwind.PhoneEditor;
            ...
            AbotutUsForm.formKey = 'HomeLess.AbotutUs';
            return AbotutUsForm;
        }(Serenity.PrefixedContext));
        HomeLess.AbotutUsForm = AbotutUsForm;
...
(function (Homeless) {
    ...
    (function (HomeLess) {
        var AbotutUsRow;
        (function (AbotutUsRow) {
            AbotutUsRow.idProperty = 'Id';
            AbotutUsRow.nameProperty = 'Name';
            AbotutUsRow.localTextPrefix = 'HomeLess.AbotutUs';
        })(AbotutUsRow = HomeLess.AbotutUsRow || (HomeLess.AbotutUsRow = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var AbotutUsService;
        (function (AbotutUsService) {
            AbotutUsService.baseUrl = 'HomeLess/AbotutUs';
            [
                'Create',
                'Update',
                'Delete',
                ...
                AbotutUsService[x] = function (r, s, o) {
                    return Q.serviceRequest(AbotutUsService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(AbotutUsService = HomeLess.AbotutUsService || (HomeLess.AbotutUsService = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var AytamPlacesForm = /** @class */ (function (_super) {
            __extends(AytamPlacesForm, _super);
            function AytamPlacesForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            AytamPlacesForm.formKey = 'HomeLess.AytamPlaces';
            return AytamPlacesForm;
        }(Serenity.PrefixedContext));
        HomeLess.AytamPlacesForm = AytamPlacesForm;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var AytamPlacesRow;
        (function (AytamPlacesRow) {
            AytamPlacesRow.idProperty = 'Id';
            AytamPlacesRow.nameProperty = 'Mobile';
            AytamPlacesRow.localTextPrefix = 'HomeLess.AytamPlaces';
        })(AytamPlacesRow = HomeLess.AytamPlacesRow || (HomeLess.AytamPlacesRow = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var AytamPlacesService;
        (function (AytamPlacesService) {
            AytamPlacesService.baseUrl = 'HomeLess/AytamPlaces';
            [
                'Create',
                'Update',
                'Delete',
                ...
                AytamPlacesService[x] = function (r, s, o) {
                    return Q.serviceRequest(AytamPlacesService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(AytamPlacesService = HomeLess.AytamPlacesService || (HomeLess.AytamPlacesService = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CategoryForm = /** @class */ (function (_super) {
            ...
            CategoryForm.formKey = 'HomeLess.Category';
            return CategoryForm;
        }(Serenity.PrefixedContext));
        HomeLess.CategoryForm = CategoryForm;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        ...
        (function (CategoryRow) {
            ...
            CategoryRow.localTextPrefix = 'HomeLess.Category';
            CategoryRow.lookupKey = 'HomeLess.Category';
            function getLookup() {
                return Q.getLookup('HomeLess.Category');
            }
            CategoryRow.getLookup = getLookup;
        })(CategoryRow = HomeLess.CategoryRow || (HomeLess.CategoryRow = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        ...
        (function (CategoryService) {
            CategoryService.baseUrl = 'HomeLess/Category';
            [
                'Create',
                'Update',
                'Delete',
        ...
        })(CategoryService = HomeLess.CategoryService || (HomeLess.CategoryService = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CityForm = /** @class */ (function (_super) {
            ...
            CityForm.formKey = 'HomeLess.City';
            return CityForm;
        }(Serenity.PrefixedContext));
        HomeLess.CityForm = CityForm;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CityRow;
        (function (CityRow) {
            CityRow.idProperty = 'Id';
            CityRow.nameProperty = 'Name';
            CityRow.localTextPrefix = 'HomeLess.City';
            CityRow.lookupKey = 'HomeLess.City';
            function getLookup() {
                return Q.getLookup('HomeLess.City');
            }
            CityRow.getLookup = getLookup;
        })(CityRow = HomeLess.CityRow || (HomeLess.CityRow = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        ...
        (function (CityService) {
            CityService.baseUrl = 'HomeLess/City';
            [
                'Create',
                'Update',
                'Delete',
        ...
        })(CityService = HomeLess.CityService || (HomeLess.CityService = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var ContactusForm = /** @class */ (function (_super) {
            __extends(ContactusForm, _super);
            function ContactusForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            ContactusForm.formKey = 'HomeLess.Contactus';
            return ContactusForm;
        }(Serenity.PrefixedContext));
        HomeLess.ContactusForm = ContactusForm;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var ContactusRow;
        (function (ContactusRow) {
            ContactusRow.idProperty = 'Id';
            ContactusRow.nameProperty = 'MessageContent';
            ContactusRow.localTextPrefix = 'HomeLess.Contactus';
        })(ContactusRow = HomeLess.ContactusRow || (HomeLess.ContactusRow = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        ...
        (function (ContactusService) {
            ContactusService.baseUrl = 'HomeLess/Contactus';
            [
                'Create',
                'Update',
                'Delete',
                ...
                ContactusService[x] = function (r, s, o) {
                    return Q.serviceRequest(ContactusService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(ContactusService = HomeLess.ContactusService || (HomeLess.ContactusService = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CountryForm = /** @class */ (function (_super) {
            ...
            CountryForm.formKey = 'HomeLess.Country';
            return CountryForm;
        }(Serenity.PrefixedContext));
        HomeLess.CountryForm = CountryForm;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        ...
        (function (CountryRow) {
            ...
            CountryRow.localTextPrefix = 'HomeLess.Country';
            CountryRow.lookupKey = 'HomeLess.Country';
            function getLookup() {
                return Q.getLookup('HomeLess.Country');
            }
            CountryRow.getLookup = getLookup;
        })(CountryRow = HomeLess.CountryRow || (HomeLess.CountryRow = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        ...
        (function (CountryService) {
            CountryService.baseUrl = 'HomeLess/Country';
            [
                'Create',
                'Update',
                'Delete',
        ...
        })(CountryService = HomeLess.CountryService || (HomeLess.CountryService = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var TopicsForm = /** @class */ (function (_super) {
            __extends(TopicsForm, _super);
            function TopicsForm(prefix) {
                var _this = _super.call(this, prefix) || this;
                if (!TopicsForm.init) {
                    ...
                    var w4 = Homeless.Northwind.PhoneEditor;
            ...
            TopicsForm.formKey = 'HomeLess.Topics';
            return TopicsForm;
        }(Serenity.PrefixedContext));
        HomeLess.TopicsForm = TopicsForm;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var TopicsRow;
        (function (TopicsRow) {
            TopicsRow.idProperty = 'Id';
            TopicsRow.nameProperty = 'TopicAddress';
            TopicsRow.localTextPrefix = 'HomeLess.Topics';
        })(TopicsRow = HomeLess.TopicsRow || (HomeLess.TopicsRow = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        ...
        (function (TopicsService) {
            TopicsService.baseUrl = 'HomeLess/Topics';
            [
                'Create',
                'Update',
                'Delete',
                ...
                TopicsService[x] = function (r, s, o) {
                    return Q.serviceRequest(TopicsService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(TopicsService = HomeLess.TopicsService || (HomeLess.TopicsService = {}));
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    })(Membership = Homeless.Membership || (Homeless.Membership = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var Membership;
...
(function (Homeless) {
    ...
    })(Northwind = Homeless.Northwind || (Homeless.Northwind = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var Northwind;
...
(function (Homeless) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Homeless.Northwind.Gender', 'Homeless.Northwind.Entities.Gender');
    })(Northwind = Homeless.Northwind || (Homeless.Northwind = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
...
(function (Homeless) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Homeless.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Homeless.LanguageList || (Homeless.LanguageList = {}));
})(Homeless || (Homeless = {}));
...
(function (Homeless) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = Homeless.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = Homeless.ScriptInitialization || (Homeless.ScriptInitialization = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var Administration;
...
(function (Homeless) {
    ...
    Homeless.BasicProgressDialog = BasicProgressDialog;
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Homeless.BasicProgressDialog();
...
(function (Homeless) {
    ...
    })(DialogUtils = Homeless.DialogUtils || (Homeless.DialogUtils = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var Common;
...
(function (Homeless) {
    ...
    Homeless.StaticTextBlock = StaticTextBlock;
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var Common;
...
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var AbotutUsDialog = /** @class */ (function (_super) {
            __extends(AbotutUsDialog, _super);
            function AbotutUsDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new HomeLess.AbotutUsForm(_this.idPrefix);
                return _this;
            }
            AbotutUsDialog.prototype.getFormKey = function () { return HomeLess.AbotutUsForm.formKey; };
            AbotutUsDialog.prototype.getIdProperty = function () { return HomeLess.AbotutUsRow.idProperty; };
            AbotutUsDialog.prototype.getLocalTextPrefix = function () { return HomeLess.AbotutUsRow.localTextPrefix; };
            AbotutUsDialog.prototype.getNameProperty = function () { return HomeLess.AbotutUsRow.nameProperty; };
            AbotutUsDialog.prototype.getService = function () { return HomeLess.AbotutUsService.baseUrl; };
            AbotutUsDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], AbotutUsDialog);
            return AbotutUsDialog;
        }(Serenity.EntityDialog));
        HomeLess.AbotutUsDialog = AbotutUsDialog;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var AbotutUsGrid = /** @class */ (function (_super) {
            __extends(AbotutUsGrid, _super);
            function AbotutUsGrid(container) {
                return _super.call(this, container) || this;
            }
            AbotutUsGrid.prototype.getColumnsKey = function () { return 'HomeLess.AbotutUs'; };
            AbotutUsGrid.prototype.getDialogType = function () { return HomeLess.AbotutUsDialog; };
            AbotutUsGrid.prototype.getIdProperty = function () { return HomeLess.AbotutUsRow.idProperty; };
            AbotutUsGrid.prototype.getLocalTextPrefix = function () { return HomeLess.AbotutUsRow.localTextPrefix; };
            AbotutUsGrid.prototype.getService = function () { return HomeLess.AbotutUsService.baseUrl; };
            AbotutUsGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], AbotutUsGrid);
            return AbotutUsGrid;
        }(Serenity.EntityGrid));
        HomeLess.AbotutUsGrid = AbotutUsGrid;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var AytamPlacesDialog = /** @class */ (function (_super) {
            __extends(AytamPlacesDialog, _super);
            function AytamPlacesDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new HomeLess.AytamPlacesForm(_this.idPrefix);
                return _this;
            }
            AytamPlacesDialog.prototype.getFormKey = function () { return HomeLess.AytamPlacesForm.formKey; };
            AytamPlacesDialog.prototype.getIdProperty = function () { return HomeLess.AytamPlacesRow.idProperty; };
            AytamPlacesDialog.prototype.getLocalTextPrefix = function () { return HomeLess.AytamPlacesRow.localTextPrefix; };
            AytamPlacesDialog.prototype.getNameProperty = function () { return HomeLess.AytamPlacesRow.nameProperty; };
            AytamPlacesDialog.prototype.getService = function () { return HomeLess.AytamPlacesService.baseUrl; };
            AytamPlacesDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], AytamPlacesDialog);
            return AytamPlacesDialog;
        }(Serenity.EntityDialog));
        HomeLess.AytamPlacesDialog = AytamPlacesDialog;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var AytamPlacesGrid = /** @class */ (function (_super) {
            __extends(AytamPlacesGrid, _super);
            function AytamPlacesGrid(container) {
                return _super.call(this, container) || this;
            }
            AytamPlacesGrid.prototype.getColumnsKey = function () { return 'HomeLess.AytamPlaces'; };
            AytamPlacesGrid.prototype.getDialogType = function () { return HomeLess.AytamPlacesDialog; };
            AytamPlacesGrid.prototype.getIdProperty = function () { return HomeLess.AytamPlacesRow.idProperty; };
            AytamPlacesGrid.prototype.getLocalTextPrefix = function () { return HomeLess.AytamPlacesRow.localTextPrefix; };
            AytamPlacesGrid.prototype.getService = function () { return HomeLess.AytamPlacesService.baseUrl; };
            AytamPlacesGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], AytamPlacesGrid);
            return AytamPlacesGrid;
        }(Serenity.EntityGrid));
        HomeLess.AytamPlacesGrid = AytamPlacesGrid;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CategoryDialog = /** @class */ (function (_super) {
            ...
            function CategoryDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new HomeLess.CategoryForm(_this.idPrefix);
                return _this;
            }
            CategoryDialog.prototype.getFormKey = function () { return HomeLess.CategoryForm.formKey; };
            CategoryDialog.prototype.getIdProperty = function () { return HomeLess.CategoryRow.idProperty; };
            CategoryDialog.prototype.getLocalTextPrefix = function () { return HomeLess.CategoryRow.localTextPrefix; };
            CategoryDialog.prototype.getNameProperty = function () { return HomeLess.CategoryRow.nameProperty; };
            CategoryDialog.prototype.getService = function () { return HomeLess.CategoryService.baseUrl; };
            CategoryDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], CategoryDialog);
            return CategoryDialog;
        }(Serenity.EntityDialog));
        HomeLess.CategoryDialog = CategoryDialog;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CategoryGrid = /** @class */ (function (_super) {
            ...
            CategoryGrid.prototype.getColumnsKey = function () { return 'HomeLess.Category'; };
            CategoryGrid.prototype.getDialogType = function () { return HomeLess.CategoryDialog; };
            CategoryGrid.prototype.getIdProperty = function () { return HomeLess.CategoryRow.idProperty; };
            CategoryGrid.prototype.getLocalTextPrefix = function () { return HomeLess.CategoryRow.localTextPrefix; };
            CategoryGrid.prototype.getService = function () { return HomeLess.CategoryService.baseUrl; };
            CategoryGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], CategoryGrid);
            return CategoryGrid;
        }(Serenity.EntityGrid));
        HomeLess.CategoryGrid = CategoryGrid;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CityDialog = /** @class */ (function (_super) {
            ...
            function CityDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new HomeLess.CityForm(_this.idPrefix);
                return _this;
            }
            CityDialog.prototype.getFormKey = function () { return HomeLess.CityForm.formKey; };
            CityDialog.prototype.getIdProperty = function () { return HomeLess.CityRow.idProperty; };
            CityDialog.prototype.getLocalTextPrefix = function () { return HomeLess.CityRow.localTextPrefix; };
            CityDialog.prototype.getNameProperty = function () { return HomeLess.CityRow.nameProperty; };
            CityDialog.prototype.getService = function () { return HomeLess.CityService.baseUrl; };
            CityDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], CityDialog);
            return CityDialog;
        }(Serenity.EntityDialog));
        HomeLess.CityDialog = CityDialog;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CityGrid = /** @class */ (function (_super) {
            ...
            CityGrid.prototype.getColumnsKey = function () { return 'HomeLess.City'; };
            CityGrid.prototype.getDialogType = function () { return HomeLess.CityDialog; };
            CityGrid.prototype.getIdProperty = function () { return HomeLess.CityRow.idProperty; };
            CityGrid.prototype.getLocalTextPrefix = function () { return HomeLess.CityRow.localTextPrefix; };
            CityGrid.prototype.getService = function () { return HomeLess.CityService.baseUrl; };
            CityGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], CityGrid);
            return CityGrid;
        }(Serenity.EntityGrid));
        HomeLess.CityGrid = CityGrid;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var ContactusDialog = /** @class */ (function (_super) {
            __extends(ContactusDialog, _super);
            function ContactusDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new HomeLess.ContactusForm(_this.idPrefix);
                return _this;
            }
            ContactusDialog.prototype.getFormKey = function () { return HomeLess.ContactusForm.formKey; };
            ContactusDialog.prototype.getIdProperty = function () { return HomeLess.ContactusRow.idProperty; };
            ContactusDialog.prototype.getLocalTextPrefix = function () { return HomeLess.ContactusRow.localTextPrefix; };
            ContactusDialog.prototype.getNameProperty = function () { return HomeLess.ContactusRow.nameProperty; };
            ContactusDialog.prototype.getService = function () { return HomeLess.ContactusService.baseUrl; };
            ContactusDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], ContactusDialog);
            return ContactusDialog;
        }(Serenity.EntityDialog));
        HomeLess.ContactusDialog = ContactusDialog;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var ContactusGrid = /** @class */ (function (_super) {
            __extends(ContactusGrid, _super);
            function ContactusGrid(container) {
                return _super.call(this, container) || this;
            }
            ContactusGrid.prototype.getColumnsKey = function () { return 'HomeLess.Contactus'; };
            ContactusGrid.prototype.getDialogType = function () { return HomeLess.ContactusDialog; };
            ContactusGrid.prototype.getIdProperty = function () { return HomeLess.ContactusRow.idProperty; };
            ContactusGrid.prototype.getLocalTextPrefix = function () { return HomeLess.ContactusRow.localTextPrefix; };
            ContactusGrid.prototype.getService = function () { return HomeLess.ContactusService.baseUrl; };
            ContactusGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], ContactusGrid);
            return ContactusGrid;
        }(Serenity.EntityGrid));
        HomeLess.ContactusGrid = ContactusGrid;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CountryDialog = /** @class */ (function (_super) {
            ...
            function CountryDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new HomeLess.CountryForm(_this.idPrefix);
                return _this;
            }
            CountryDialog.prototype.getFormKey = function () { return HomeLess.CountryForm.formKey; };
            CountryDialog.prototype.getIdProperty = function () { return HomeLess.CountryRow.idProperty; };
            CountryDialog.prototype.getLocalTextPrefix = function () { return HomeLess.CountryRow.localTextPrefix; };
            CountryDialog.prototype.getNameProperty = function () { return HomeLess.CountryRow.nameProperty; };
            CountryDialog.prototype.getService = function () { return HomeLess.CountryService.baseUrl; };
            CountryDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], CountryDialog);
            return CountryDialog;
        }(Serenity.EntityDialog));
        HomeLess.CountryDialog = CountryDialog;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var CountryGrid = /** @class */ (function (_super) {
            ...
            CountryGrid.prototype.getColumnsKey = function () { return 'HomeLess.Country'; };
            CountryGrid.prototype.getDialogType = function () { return HomeLess.CountryDialog; };
            CountryGrid.prototype.getIdProperty = function () { return HomeLess.CountryRow.idProperty; };
            CountryGrid.prototype.getLocalTextPrefix = function () { return HomeLess.CountryRow.localTextPrefix; };
            CountryGrid.prototype.getService = function () { return HomeLess.CountryService.baseUrl; };
            CountryGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], CountryGrid);
            return CountryGrid;
        }(Serenity.EntityGrid));
        HomeLess.CountryGrid = CountryGrid;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (HomeLess) {
        var TopicsDialog = /** @class */ (function (_super) {
            ...
            function TopicsDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new HomeLess.TopicsForm(_this.idPrefix);
                return _this;
            }
            TopicsDialog.prototype.getFormKey = function () { return HomeLess.TopicsForm.formKey; };
            TopicsDialog.prototype.getIdProperty = function () { return HomeLess.TopicsRow.idProperty; };
            TopicsDialog.prototype.getLocalTextPrefix = function () { return HomeLess.TopicsRow.localTextPrefix; };
            TopicsDialog.prototype.getNameProperty = function () { return HomeLess.TopicsRow.nameProperty; };
            TopicsDialog.prototype.getService = function () { return HomeLess.TopicsService.baseUrl; };
            TopicsDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], TopicsDialog);
            return TopicsDialog;
        }(Serenity.EntityDialog));
        HomeLess.TopicsDialog = TopicsDialog;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var HomeLess;
    (function (HomeLess) {
        var TopicsGrid = /** @class */ (function (_super) {
            __extends(TopicsGrid, _super);
            function TopicsGrid(container) {
                return _super.call(this, container) || this;
            }
            TopicsGrid.prototype.getColumnsKey = function () { return 'HomeLess.Topics'; };
            TopicsGrid.prototype.getDialogType = function () { return HomeLess.TopicsDialog; };
            TopicsGrid.prototype.getIdProperty = function () { return HomeLess.TopicsRow.idProperty; };
            TopicsGrid.prototype.getLocalTextPrefix = function () { return HomeLess.TopicsRow.localTextPrefix; };
            TopicsGrid.prototype.getService = function () { return HomeLess.TopicsService.baseUrl; };
            TopicsGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], TopicsGrid);
            return TopicsGrid;
        }(Serenity.EntityGrid));
        HomeLess.TopicsGrid = TopicsGrid;
    })(HomeLess = Homeless.HomeLess || (Homeless.HomeLess = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Homeless.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(Homeless.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(Homeless.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Homeless.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Homeless.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Homeless.Authorization.userDefinition.DisplayName,
...
(function (Homeless) {
    ...
    (function (Northwind) {
        ...
        }(Homeless.Common.GridEditorDialog));
...
(function (Homeless) {
    ...
    (function (Northwind) {
        ...
        }(Homeless.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return Homeless.LanguageList.getValue();
            };
...
(function (Homeless) {
    ...
    })(Authorization = Homeless.Authorization || (Homeless.Authorization = {}));
})(Homeless || (Homeless = {}));
var Homeless;
(function (Homeless) {
    var BasicSamples;
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        }(Homeless.Northwind.ProductDialog));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        }(Homeless.Northwind.ProductGrid));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Homeless.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Homeless.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Homeless.Northwind.OrderDialog();
                        ...
                        var chai = Homeless.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Homeless.Northwind.EmployeeRow.getLookup().items
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        }(Homeless.Northwind.OrderDialog));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Homeless.Northwind.CategoryService.Retrieve({
        ...
        }(Homeless.Northwind.CategoryDialog));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        }(Homeless.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Homeless.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Homeless.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Homeless.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Homeless.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Homeless.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Homeless.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Homeless.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Homeless.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Homeless.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Homeless.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Homeless.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Homeless.Northwind.OrderService.baseUrl; };
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        }(Homeless.Northwind.SupplierDialog));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Homeless.Northwind.SupplierGrid));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Homeless.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Homeless.Northwind.CustomerDialog));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        }(Homeless.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Homeless.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Homeless.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Homeless.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Homeless.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Homeless.Northwind.OrderDetailDialog));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        }(Homeless.Northwind.OrderDetailsEditor));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Homeless.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Homeless.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Homeless.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Homeless.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Homeless.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        ...
        }(Homeless.Common.BulkServiceAction));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Homeless.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Homeless.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Homeless.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Homeless.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Homeless.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Homeless.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Homeless.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Homeless.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Homeless) {
    ...
    Homeless.SelectableEntityGrid = SelectableEntityGrid;
})(Homeless || (Homeless = {}));
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Homeless.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Homeless.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Homeless.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Homeless.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Homeless.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Homeless.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Homeless.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Homeless.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Homeless.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Homeless.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Homeless.Northwind.ProductService.baseUrl; };
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Homeless.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Homeless.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Homeless.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Homeless.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Homeless.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Homeless.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Homeless) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Homeless.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Homeless.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Homeless.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=Homeless.Web.js.map