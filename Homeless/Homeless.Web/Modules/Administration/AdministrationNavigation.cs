...
using Administration = Homeless.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "fa-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: Homeless.Administration.PermissionKeys.Security, icon: "fa-ban", Target = "_blank")]
